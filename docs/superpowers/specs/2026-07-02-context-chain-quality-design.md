...
**Date:** 2026-07-02
**Status:** Historical design; parked and superseded by the 2026-08-09
current-use audit
...
> This document preserves the July design context. Its provider inventory,
> counts, and paths predate the Claude/Codex-only consolidation. Re-discover
> current state from the
> [2026-08-09 audit](../../reviews/review-2026-08-09-ai-skills-current-use-audit.md)
> before reviving any part of the proposal.
