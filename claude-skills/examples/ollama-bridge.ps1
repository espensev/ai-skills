...
function Resolve-OllamaModel {
    ...
    switch ($normalizedTier) {
        "haiku" { if ($script:HaikuModel) { return $script:HaikuModel } }
        "sonnet" { if ($script:SonnetModel) { return $script:SonnetModel } }
        "opus" { if ($script:OpusModel) { return $script:OpusModel } }
    }
