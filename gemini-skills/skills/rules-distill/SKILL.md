...
Use the `read_file` tool to ingest the current project conventions from `GEMINI.md` and any associated architecture files (e.g., `docs/system-map.md`, `docs/campaign-blueprints.md`).
