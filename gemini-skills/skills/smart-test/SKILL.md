...
## Core Mandate
Given a set of changed files, determine and run the minimal test subset instead of the full test suite. Read module definitions from project.toml and build source-to-test mappings dynamically. Follow the global guardrails in GEMINI.md.

**All commands run to completion autonomously.**

**Config:** `.gemini/skills/project.toml` — modules, test commands, conflict zones
...
## Setup: Load Config
Before any command:
1. Read `.gemini/skills/project.toml`
