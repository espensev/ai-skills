...
## Execution Rules
1. **Read config first:** Read `project.toml` and extract the `[docs-sync]` section before any command. This is an ops drift skill, not a planning skill; no planning-contract gate applies. Follow AGENTS.md for house consistency.
