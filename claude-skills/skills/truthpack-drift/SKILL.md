...
description: "Compare declared truth files (JSON/YAML/TOML fact stores) against the actual codebase to detect divergence. Catches stale single-source-of-truth references."
