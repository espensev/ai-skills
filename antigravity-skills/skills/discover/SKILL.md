---
name: discover
description: "Produce docs/system-map.md from read-only repository analysis. Use when codebase understanding, dependency mapping, feasibility assessment, or constraint discovery is needed before planning."
---
