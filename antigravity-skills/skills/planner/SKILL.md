---
name: planner
description: "Produce docs/planning-contract.md from the discovery artifact. Use when planning work decomposition, agent tasks, dependencies, file ownership, or a campaign before execution."
---
