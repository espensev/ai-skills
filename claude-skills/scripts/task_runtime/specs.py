...
def configured_verification_commands(
    ...
    *,
    ...
    if not commands:
        commands.append("# Add verification commands in .claude/skills/project.toml [commands]")
    return commands
...
No tracker file configured in `.claude/skills/project.toml`.
"""
    return f"""\
## Post-completion
...
def render_spec_template(
    ...
    *,
    ...
    files: list[str] | None = None,
    plan: dict | None = None,
    conventions_file: str = "CLAUDE.md",
    tracker_path: str = "",
