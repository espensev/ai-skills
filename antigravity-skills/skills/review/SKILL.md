...
# Review Agent (Antigravity Adapter)

Review changed work without modifying source files. Use Antigravity's broad context
...
already-fetched diff chunks. Antigravity remains responsible for verifying every
