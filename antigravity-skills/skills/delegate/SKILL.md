...
## Execution Rules
1. **Follow the guardrails:** Operate under the global guardrails in AGENTS.md. This is an ops/routing skill, not a planning skill — no planning-contract gate applies.
