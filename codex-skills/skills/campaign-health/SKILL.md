...
**Config:** `.codex/skills/project.toml` - paths to state, plans, specs
...
- `.codex/state/`, `docs/agents/`, `docs/campaigns/`
...
Campaign Health - Stuck Items
  ...
  Orphaned Worktrees:
    .worktrees/wt-experiment - no agent reference, 5 days old
    Recovery: git worktree remove .worktrees/wt-experiment
