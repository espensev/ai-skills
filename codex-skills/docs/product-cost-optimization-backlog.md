...
2. Add safe fixes:
- If `.codex/skills/planning-contract.md` is missing but package contract is
  available, copy/install it.
- If `[project].conventions` path is missing and `AGENTS.md` exists at repo
...
| P0 — Safe remediation | **DONE** | 2026-03-12 (--fix-safe copies planning-contract, creates AGENTS.md stub) |
