...
## Execution Rules
1. **Adhere to the Contract:** Follow the 13-element Planning Contract and the global guardrails in GEMINI.md.
...
6. **Hooks JSONL** (optional, varies by install) — `.gemini/hooks/logs/hooks-log.jsonl` for tool-level events
