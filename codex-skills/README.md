...
| `planning-contract.md` | Shared planning contract copied into `.codex/skills/` |
...
`init --force` renders `.codex/skills/project.toml`, creates the runtime state
...
`plan-schema.md` and `analysis-schema.md` into `<project>/.codex/skills/`.
...
cp planning-contract.md project.toml.template ~/.codex/skills/
```

The `init --force` command renders `.codex/skills/project.toml` from
...
All project-specific values live in `.codex/skills/project.toml`. Ship
...
|---|---|
| `.codex/skills/manager/SKILL.md` | Manager skill runtime doc |
| `.codex/skills/planner/SKILL.md` | Planner skill runtime doc (includes refactor mode) |
| `.codex/skills/planning-contract.md` | Shared planning contract |
| `.codex/skills/project.toml` | Generated project-local config |
...
- lightweight skill scoring via `eval/README.md` and `scripts/eval_skills.py`
