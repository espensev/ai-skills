...
**Config:** `.claude/skills/project.toml` — doc surfaces in `[docs-sync]`
...
files = ["CLAUDE.md", "README.md", "STATUS.md", "CONTRIBUTING.md"]
...
1. Auto-discover documentation files:
   - Tier 1: `README.md`, `CLAUDE.md`, `CONTRIBUTING.md`, `STATUS.md`
...
Docs Sync — Check
  ...
  Cross-Doc Consistency:
    FAIL — CLAUDE.md says port 8080, CONTRIBUTING.md says port 3000
